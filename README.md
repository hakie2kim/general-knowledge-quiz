...
사용자는 `사용자 이름:` 옆의 텍스트 상자에 사용자 이름을 입력할 수 있습니다. 사용자가 이름을 확인할 수 있도록 `사용자 이름 확인`이라는 버튼이 아래에 있습니다. 사용자가 `사용자 이름 확인` 버튼을 누르면 버튼 옆에 사용자가 입력한 이름이 표시되는 확인 메시지가 나타납니다.
...
- 사용자는 `역사`와 `지리` 버튼 중 두 가지 주제를 선택할 수 있습니다.
  - `역사` 버튼을 클릭하면 `history.php` 페이지로 이동합니다.
  - `지리` 버튼을 클릭하면 `geography.php` 페이지로 이동합니다.
...
사용자가 `점수별 정렬` 버튼을 클릭하면 리더 보드의 총점을 내림차순으로 정렬합니다. 사용자가 `역사 시도` 버튼을 클릭하면 `history.php` 페이지로 이동하여 역사 퀴즈를 시도할 수 있습니다. 사용자가 `지리 시도` 버튼을 클릭하면 `geography.php` 페이지로 이동하여 지리 퀴즈를 시도할 수 있습니다.
